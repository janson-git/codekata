...
class DataMuningTest extends PHPUnit_Framework_TestCase
{
    protected $weatherData;
    /** @var  MinSpreadSearcher */
    protected $searcher;
    
    public function setUp()
    {
        $this->weatherData = file_get_contents(__DIR__ . '/../../data/weather.dat');
        $this->searcher = new MinSpreadSearcher();
    }

    /**
     * @dataProvider provideSpreadData
     */
    public function testSearchMinTemperatureSpread($expect, $data)
    {
        $actual = $this->searcher->findIndexOfMinSpread($data);
        $this->assertEquals($expect, $actual);
    }
    
    public function provideSpreadData()
    {
        return [
            [2, 
